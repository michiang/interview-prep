...
const findRectangleOverlap = (rectangle1, rectangle2) => {
	let xOverlap = findRangeOverlap( rectangle1.x, rectangle1.width, rectangle2.x, rectangle2.width );
	let yOverlap = findRangeOverlap( rectangle1.y, rectangle1.height, rectangle2.y, rectangle2.height );
